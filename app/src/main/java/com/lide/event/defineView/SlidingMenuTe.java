...
public class SlidingMenuTe extends HorizontalScrollView {
	...
	public SlidingMenuTe(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		//处理动画
		//滑动百分比因子
		float factor = (float)l / mMenuWidth;   //左往右滑的过程中值从1到0
